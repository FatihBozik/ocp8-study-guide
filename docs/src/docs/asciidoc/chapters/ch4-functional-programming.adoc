...
The following code creates an infinite stream of numbers counting from 1. The skip operation returns an infinite stream starting with the numbers counting from 6, since it skips the first five elements.
